...
{ ?>
  ...
  <script type="text/javascript">
    document.addEventListener("DOMContentLoaded", function(event) {
      ...
      loginImg.src = "<?= get_template_directory_uri() ?>/images/chw.png";
...
/**
 * Register Mailtrap Settings
 * Only for development and testing purposes
 */
// if (WP_SITEURL === 'http://localhost/ieb/') {
...
//     $phpmailer->Port = 2525;
//     $phpmailer->Username = 'e9dbaf68534d30';
//     $phpmailer->Password = '28072108cdbe7a';
//   }
